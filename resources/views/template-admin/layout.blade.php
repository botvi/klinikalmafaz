...
<head>
    ...
    <title>Dashboard - Klinik Al Mafaz</title>



    <link href="{{ asset('admin') }}/assets/compiled/svg/favicon.svg" rel="shortcut icon" type="image/x-icon">
    <link
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><span>Al Mafaz</span></a>
                        </div>
                        <div class="theme-toggle d-flex gap-2  align-items-center mt-2">
                            <svg aria-hidden="true" class="iconify iconify--system-uicons" height="20"
                                preserveAspectRatio="xMidYMid meet" role="img" viewBox="0 0 21 21" width="20"
                            ...
                            <div class="form-check form-switch fs-6">
                                <input class="form-check-input  me-0" id="toggle-dark" style="cursor: pointer"
                                    type="checkbox">
                                <label class="form-check-label"></label>
                            </div>
                            <svg aria-hidden="true" class="iconify iconify--mdi" height="20"
                                preserveAspectRatio="xMidYMid meet" role="img" viewBox="0 0 24 24" width="20"
                                xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="sidebar-toggler  x">
                            <a class="sidebar-hide d-xl-none d-block" href="#"><i
